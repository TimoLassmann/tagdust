...
extern int random_score(struct model_bag* mb,const uint8_t* a,const int len);
...
extern int forward_max_posterior_decoding(struct model_bag* mb, const uint8_t* a,char** label, int len);
