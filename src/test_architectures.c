...
int test_architectures(struct parameters* param, int file_num)
{
        ...
        MMALLOC(tmp, sizeof(char) * BUFFER_LEN);
                ...
                if( byg_end("tagdust",line)){
                        ...
                        for(c = 0;c < 10;c++){
                                ...
                                if(index){
                                        ...
                                        RUN(assign_segment_sequences(param, tmp , c));
